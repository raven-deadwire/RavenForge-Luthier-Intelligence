...
(async()=>{
 ...
 await load(`assets/analysis-special-components-2.js?v=${v}`);
 await load(`assets/analysis-special-amplification.js?v=${v}`);
 await load(`assets/analysis-technology-cleanup.js?v=${v}`);
 await load(`assets/analysis-review-core.js?v=${v}`);
 await load(`assets/analysis-degier.js?v=${v}`);
 await load(`assets/analysis-structure-normalize.js?v=${v}`);
 await load(`assets/analysis-amplification-review.js?v=${v}`);
 await load(`assets/analysis-technology-sources.js?v=${v}`);
 await load(`assets/analysis-amplification-sources.js?v=${v}`);
 ...
 await load(`assets/analysis-components-media-pair-1.js?v=${v}`);
 await load(`assets/analysis-components-media-pair-2.js?v=${v}`);
 await load(`assets/analysis-components-media-pair-3.js?v=${v}`);
 await load(`assets/analysis-components-media-pair-4.js?v=${v}`);
 await load(`assets/analysis-components-media-pair-5.js?v=${v}`);
 await load(`assets/analysis-components-media-pair-6.js?v=${v}`);
