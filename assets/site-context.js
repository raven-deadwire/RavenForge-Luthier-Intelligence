...
(() => {
  ...
  const copy = {
    en: {
      ...
      formTitle: 'FORM',
      formLead: 'Ergonomics for expression.',
      formBody: 'Geometry, balance and access are developed around the player. Form should support long sessions and musical intent rather than exist as decoration.',
      materialTitle: 'MATERIAL',
      materialLead: 'Tradition meets exploration.',
    ...
    de: {
      ...
      formTitle: 'FORM',
      formLead: 'Ergonomie für Ausdruck.',
      formBody: 'Geometrie, Balance und Erreichbarkeit werden vom Spieler aus entwickelt. Form soll lange Sessions und musikalische Absicht unterstützen, nicht bloß dekorativ sein.',
      materialTitle: 'MATERIAL',
      materialLead: 'Tradition trifft Erkundung.',
    ...
    ko: {
      ...
      formTitle: 'FORM',
      formLead: '표현을 위한 인체공학.',
      formBody: '기하 구조, 밸런스와 접근성은 연주자를 중심으로 설계합니다. 형태는 장식이 아니라 긴 연주와 음악적 의도를 뒷받침해야 합니다.',
      materialTitle: 'MATERIAL',
      materialLead: '전통과 탐구의 접점.',
