...
(() => {
  ...
  const SOLO_ARTIST_URL = 'https://music.bugs.co.kr/artist/20194990?wl_ref=S_tr_01_03';
  const LIVE_VIDEO_URL = 'https://www.youtube.com/watch?v=LKsgpo1rUFY';
  const LIVE_EMBED_URL = 'https://www.youtube.com/embed/LKsgpo1rUFY';
  ...
  const copy = {
    en: {
      ...
      soloProfile: 'Solo artist profile',
      releaseLabel: 'RELEASE',
      listen: 'Listen',
      performanceLabel: 'LIVE / PERFORMANCE',
      performanceTitle: 'DEADWIRE — Live Performance',
      performanceMeta: "'raven — Bass & Vocal",
      performanceDesc: 'A representative DEADWIRE stage showing the high-gain band context, physical workload and practical playing environment that inform RavenForge’s design questions.',
      ...
      careerLabel: 'Music',
      career: "DEADWIRE — Bass & Vocal / Composition / Management<br>Solo artist — 'raven<br>Former bassist: Hate Device / Purgatorium",
      ...
      intro: `<p class="mb-4">I am Raven Cho (@raven_deadwire), a bassist, vocalist and composer whose instrument-design work begins with problems encountered in recording, rehearsal and live performance.</p><p class="mb-4">I studied philosophy at Yonsei University, and I use that background less as a credential than as a working method: define the question, separate assumptions from evidence, and connect form, material and use without treating tradition as proof by itself. My solo work as 'raven and DEADWIRE, my melodic-death-metal project, are the practical environments in which many RavenForge questions emerge.</p><p>I am currently developing RavenForge as an independent instrument-design and lutherie research project while continuing hands-on repair, setup and prototype training. The published models are design proposals under development, not claims of finished production performance.</p>`,
    ...
    de: {
      ...
      soloProfile: 'Solo-Künstlerprofil',
      releaseLabel: 'VERÖFFENTLICHUNG',
      listen: 'Anhören',
      performanceLabel: 'LIVE / PERFORMANCE',
      performanceTitle: 'DEADWIRE — Live-Performance',
      performanceMeta: "'raven — Bass & Gesang",
      performanceDesc: 'Eine repräsentative DEADWIRE-Bühne, die den High-Gain-Bandkontext, die körperliche Belastung und die praktische Spielumgebung hinter vielen RavenForge-Fragen zeigt.',
      watch: 'Auf YouTube öffnen',
      ...
      careerLabel: 'Musik',
      career: "DEADWIRE — Bass & Gesang / Komposition / Management<br>Solo-Künstler — 'raven<br>Ehemaliger Bassist: Hate Device / Purgatorium",
    ...
    ko: {
      ...
      soloProfile: '솔로 아티스트 프로필',
      releaseLabel: 'RELEASE',
      listen: '음원 듣기',
      performanceLabel: 'LIVE / PERFORMANCE',
      performanceTitle: 'DEADWIRE — Live Performance',
      performanceMeta: "'raven — Bass & Vocal",
      performanceDesc: '하이게인 밴드 믹스, 연주 시 신체적 부담, 실제 무대 환경처럼 RavenForge의 여러 설계 질문이 출발하는 조건을 보여주는 대표 라이브입니다.',
      watch: 'YouTube에서 보기',
      profileTitle: '현재 프로필',
      nameLabel: '활동명',
      name: "'raven / Raven Cho",
      ...
      careerLabel: '음악 활동',
      career: "DEADWIRE — Bass & Vocal / 작곡 / 매니지먼트<br>솔로 아티스트 — 'raven<br>전 Hate Device / Purgatorium 베이시스트",
      trainingLabel: '리페어 및 제작',
      training: 'Berklee GT Repair — 리페어·셋업 실무 견습<br>Moon Guitar — 프로토타입 개발 및 제작 수련<br>가구기능사 과정 — 2026',
      intro: `<p class="mb-4">안녕하세요, Raven Cho(@raven_deadwire)입니다. 베이스와 보컬, 작곡을 해온 뮤지션으로서 제 악기 설계는 녹음·합주·공연에서 실제로 마주친 문제에서 출발합니다.</p><p class="mb-4">연세대학교에서 철학을 전공했고, 이 배경을 단순한 이력보다 작업 방법으로 활용하고 있습니다. 질문을 명확히 정의하고, 가정과 근거를 분리하며, 전통 자체를 증거로 삼지 않은 채 형태·재료·사용 맥락을 연결하려 합니다. 솔로 아티스트 'raven과 멜로딕 데스 메탈 프로젝트 DEADWIRE는 RavenForge의 많은 설계 질문이 생겨나는 실제 음악 환경입니다.</p><p>현재 RavenForge는 독립적인 악기 설계·루씨어리 연구 프로젝트로 개발 중이며, 리페어·셋업과 프로토타입 제작 수련을 병행하고 있습니다. 홈페이지에 공개된 모델은 개발 중인 설계안이며, 아직 완성된 양산 제품의 성능을 주장하는 것이 아닙니다.</p>`,
  ...
  const releases = [
    { year: '2026', artist: 'DEADWIRE', title: 'From Destiny They Called', meta: 'EP · Bass / Vocal / Composition', url: 'https://www.melon.com/album/detail.htm?albumId=13354177' },
    { year: '2023', artist: "'raven", title: 'Revenant Raven', meta: 'EP 1', url: 'https://www.melon.com/album/detail.htm?albumId=11328931' },
    { year: '2023', artist: "'raven", title: 'A Warrior Betrayed Us', meta: 'EP 2', url: 'https://www.melon.com/album/music.htm?albumId=11345098' }
  ];
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .rf-profile-links { display:flex; flex-wrap:wrap; gap:.7rem; margin-top:1rem; }
      .rf-profile-links a { display:inline-flex; align-items:center; min-height:44px; padding:.55rem .8rem; border:1px solid var(--rf-line); color:var(--rf-ink); font-size:.86rem; font-weight:600; background:rgb(248 249 246 / .55); }
      .rf-profile-links a:hover { border-color:#b88965; }
      ...
      .rf-performance-card { display:grid; grid-template-columns:minmax(0,1.05fr) minmax(0,.95fr); margin-top:1rem; border:1px solid var(--rf-line); background:rgb(248 249 246 / .55); overflow:hidden; }
      .rf-performance-video { position:relative; min-height:18rem; background:#101b23; }
      .rf-performance-video iframe { position:absolute; inset:0; width:100%; height:100%; border:0; }
      ...
      @media (max-width:800px) { .rf-release-grid { grid-template-columns:1fr; } .rf-release-card { min-height:11rem; } .rf-profile-feature-head,.rf-performance-card { grid-template-columns:1fr; } .rf-performance-video { min-height:56vw; max-height:22rem; } }
    `;
    ...
    section.innerHTML = `
      <div class="rf-profile-feature-head">
        ...
        <div>
          ...
          <div class="rf-profile-links"><a href="${SOLO_ARTIST_URL}" target="_blank" rel="noopener noreferrer">${t.soloProfile} →</a></div>
        </div>
      </div>
      <div class="rf-release-grid">${cards}</div>
      <article class="rf-performance-card">
        <div class="rf-performance-video">
          <iframe src="${LIVE_EMBED_URL}" title="${t.performanceTitle}" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        <div class="rf-performance-copy">
          ...
          <a href="${LIVE_VIDEO_URL}" target="_blank" rel="noopener noreferrer">${t.watch} →</a>
        </div>
      </article>`;
    return section;
  }
