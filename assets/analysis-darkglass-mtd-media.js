...
window.RF_ANALYSIS_EXTRA_MEDIA=Object.assign(window.RF_ANALYSIS_EXTRA_MEDIA||{}, {
 ...
 'Michael Tobias Design (MTD)':{
  pair:true,
  model:'535-24 / USA 535',
  shots:[
   {label:'535-24',src:'https://images.squarespace-cdn.com/content/v1/52db2345e4b02995f7e0a10f/c50f3c40-bae4-49fc-b49b-5570205efb98/FullSizeRender.jpeg',pos:'50% 54%',fit:'cover',modalFit:'contain'},
   {label:'USA 535',src:'https://rvb-img.reverb.com/image/upload/s--6MHPtqf5--/t_card-square/v1652310904/jz9pr5grjouv2snwer22.png',pos:'50% 50%',fit:'contain',modalFit:'contain'}
  ],
