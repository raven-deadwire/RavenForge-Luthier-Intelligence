...
let K='all';
const lang=()=>['en','de','ko'].includes(R.lang)?R.lang:'en';
...
const review=document.createElement('script');review.src='assets/analysis-review.js?v=20260914s14';review.async=false;document.body.appendChild(review);
})();